In chapter 3, we introduce non-linear search chaining, whereby modeling pipelines are composed which each fit a
different model.
...
`Tutorial 5: Complex Source <https://mybinder.org/v2/gh/Jammy2211/autogalaxy_workspace/release?filepath=notebooks/howtogalaxy/chapter_3_search_chaining/tutorial_5_complex_source.ipynb>`_
