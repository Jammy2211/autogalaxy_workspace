...
This is illustrated in the ``start_here`` / ``start_here.ipynb`` file, where new users should begin.
...
- ``examples``: Examples showing how to use all of the core plotting API.- ``advanced``: Advanced examples showing how to use the plotting API to create custom plots.