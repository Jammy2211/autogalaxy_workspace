The ``guides`` folder contains guides explaining how specific aspects of **PyAutoGalaxy** work.
...
The following files in the ``guide`` folder are important, providing a full overview of the core API fundamental to
most calculations.
