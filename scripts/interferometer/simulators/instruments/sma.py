...
`/autogalaxy_workspace/dataset/interferometer/instruments/sma/simple__sersic`
"""
...
"""
The dataset can be viewed in the folder `autogalaxy_workspace/interferometer/instruments/sma`.
"""
