...
exploits the sparsity of the pixelized galaxy reconstructions and means a very small amount of memory or VRAM is used.
...
Pixelized galaxy modeling requires heavy linear algebra operations. These calculations are greatly accelerated
...
- `w_tilde` exploits the **sparsity** of the matrices used in pixelized galaxy reconstruction.
...
which reused in all subsequent pixelized galaxy fits.
...
"""
curvature_preload = ag.load_curvature_preload_if_compatible(
