...
__CASA to PyAutoGalaxy__

The interferometer object in AutoGalaxy takes as arguments the visibilities, uv_wavelengths and noise_map (i.e. the
...
Now back to where we started ... AutoGalaxy requires you to create the object "interferometer":
"""
#
...
# visibilities=ag.Visibilities(visibilities[:, 0] + 1j * visibilities[:, 1])
