...
dataset_name = "simple__1"

"""
The path where the dataset will be output, which in this case is:
`/autogalaxy_workspace/dataset/database/simple__1`
"""
...
galaxy = ag.Galaxy(
    ...
    bulge=ag.lp.Sersic(
        centre=(0.0, 0.0),
        ell_comps=ag.convert.ell_comps_from(axis_ratio=0.6, angle=12.0),
        intensity=2.0,
    ...
    disk=ag.lp.Exponential(
        centre=(0.0, 0.0),
        ell_comps=ag.convert.ell_comps_from(axis_ratio=0.8, angle=80.0),
        intensity=0.7,
