The ``imaging`` folder contains example scripts showing how to analyse galaxies with
CCD imaging data (E.g. Hubble Space Telescope, James Webb Space Telescope)
...
- ``start_here``: A simple example illustrating how to analyse CCD imaging data.
...
- ``simulator_sample``: How to simulate a sample of galaxies observed with CCD imaging data.
