...
`/autogalaxy_workspace/dataset/imaging/instruments/vro`
"""
...
mat_plot = aplt.MatPlot2D(
    title=aplt.Title(label="Vero Rubin Observatory Image"),
...
"""
The dataset can be viewed in the folder `autogalaxy_workspace/imaging/instruments/vro`.
"""
