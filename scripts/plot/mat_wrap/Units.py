...
**PyAutoGalaxy** has internal units which are used for calculations and model-fitting (e.g. arc-seconds,
...
in`autogalaxy_workspace/*/imaging/results/examples/units_and_cosmology.ipynb`. Unit conversions in general is
