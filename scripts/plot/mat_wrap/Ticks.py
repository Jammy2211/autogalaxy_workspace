...
This example illustrates how to customize the Ticks of a figure or subplot displayed in PyAutoGalaxy, by
...
yticks = aplt.YTicks(alpha=0.8, fontsize=10, rotation="vertical", va="bottom")
