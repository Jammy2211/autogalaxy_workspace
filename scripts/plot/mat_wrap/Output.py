...
This example illustrates how to output a PyAutoGalaxy figure or subplot.
...
the default behaviour of PyAutoGalaxy plots, but can be manually specified using the `format-"show"`
"""
