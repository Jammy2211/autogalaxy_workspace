...
This example illustrates how to plot and customize (y,x) grids of coordinates in PyAutoGalaxy figures and subplots.
"""
# %matplotlib inline
...
"""
There are numerous (y,x) grids of coordinates that PyAutoGalaxy plots. For example, in addition to the origin,
