...
**PyAutoGalaxy** also provides a `Grid2DIterate` grid, which uses iteratively higher and higher levels of sub gridding
to evaluate a `from_grid_` method until a threshold level of accuracy is met. This is used in many of the example
`simulator` scripts to ensure that the images of simulated galaxies are evaluated accurately. 
