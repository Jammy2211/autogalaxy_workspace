...
"""
aplt.plot_array(array=psf.kernel, title="PSF 2D Kernel", use_log10=True)
...
"""
aplt.plot_array(array=image, title="Galaxy Image Before PSF")
...
"""
aplt.plot_array(array=dataset.psf.kernel, title="Simulated PSF", use_log10=True)
