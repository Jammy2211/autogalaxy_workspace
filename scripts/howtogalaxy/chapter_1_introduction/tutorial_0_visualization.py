...
Throughout the **HowToGalaxy** lectures you'll see lots more objects that can be included on figures and subplots.

Just like the matplotlib setup, you can customize what does and does not appear on figures by default using the 
config file `autogalaxy_workspace/config/visualize/include.yaml`
